import torch
from models.network.detr_tracking_variants.encoder_shared_params_decoder_cross_attn_2.builder import build_detr_tracking_network, initialize_detr_tracking_network
