import torch
from models.network.detr_tracking_variants.encoder_shared_params_decoder_cross_attn_decoder_no_z_mask.builder import \
    build_detr_tracking_network, initialize_detr_tracking_network
...
from data.detr_tracking_variants.simple.training_builder import build_training_processor
...
def build_detr_tracking_training_actor(args, net_config: dict, train_config: dict,
...
def build_training_actor_and_dataloader(args, network_config: dict, train_config: dict, train_dataset_config_path: str,
    ...
    actor = build_detr_tracking_training_actor(args, network_config, train_config,
                                               epoch_changed_event_signal_slots)
