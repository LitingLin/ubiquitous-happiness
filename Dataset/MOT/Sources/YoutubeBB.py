...
def construct_YoutubeBB(constructor, seed):
    ...
    for youtube_id, video_annotations in annotations.items():
        ...
        constructor.setSequenceName(youtube_id)
        constructor.setSequenceFPS(1)
        ...
        for time_stamp, object_annotation in video_annotations.items():
            ...
            for (object_id, class_id), (bounding_box, is_present) in object_annotation.items():
                if (object_id, class_id) not in registered_object:
                    ...
                    constructor.addObject(id_, YoutubeBBClassIndexNameMapper[class_id])
                ...
                constructor.addRecord(index_of_frame, id_, bounding_box, is_present == 'present')
