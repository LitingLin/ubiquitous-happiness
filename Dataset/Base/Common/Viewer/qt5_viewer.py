...
def draw_object(painter, bounding_box_accessor, bounding_box_validity_flag_accessor, category_id_accessor, object_id_accessor, category_id_color_map, category_id_name_map_accessor, context_accessor):
