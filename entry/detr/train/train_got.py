...
def get_args_parser():
    ...
    parser.add_argument('--got_path', type=str)
...
def build_dataloader(is_distributed: bool, num_workers: int, got_path: str, coco_path: str, batch_size: int):
    ...
    from Dataset.SOT.FactorySeeds.GOT10k import GOT10k_Seed
    ...
    from data.detr_wrapper.tracking_wrapper import DETRSOTDataset
