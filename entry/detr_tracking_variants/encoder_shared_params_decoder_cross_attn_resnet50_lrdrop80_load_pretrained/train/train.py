...
default_config_path = os.path.join(root_path, 'config', 'detr_tracking_variants', 'encoder_shared_params_decoder_cross_attn_resnet50_lrdrop80')

import argparse
from pathlib import Path
import Utils.detr_misc as utils
from training.detr_tracking_variants.training_loop import training_loop
from training.detr_tracking_variants.encoder_shared_params_decoder_cross_attn_load_pretrained.builder import build_training_actor_and_dataloader
