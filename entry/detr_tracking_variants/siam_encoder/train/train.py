...
default_config_path = os.path.join(root_path, 'config', 'detr_tracking_variants', 'siam_encoder')

import argparse
from pathlib import Path
import Utils.detr_misc as utils
from training.detr_tracking.training_loop import training_loop
from training.detr_tracking.siam_encoder.build import build_training_actor_and_dataloader
