...
default_config_path = os.path.join(root_path, 'config', 'detr_tracking_variants', 'encoder_shared_params_decoder_cross_attn_resnet50_decoder_no_z_mask_new_aug_inference_size_limit')

from algorithms.tracker.detr_tracking_variants.encoder_shared_params_decoder_cross_attn_resnet50_decoder_no_z_mask_new_aug_z_blank_background_no_mask_inference_size_limit.builder import build_detr_tracker
...
if __name__ == '__main__':
    ...
    tracker = build_detr_tracker(args.net_config, args.weight_path, args.device, "encoder_shared_params_decoder_cross_attn_resnet50_decoder_no_z_mask_new_aug_inference_size_limit")
