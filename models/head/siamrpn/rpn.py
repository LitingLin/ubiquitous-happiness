...
from models.operator.cross_correlation.func import xcorr, xcorr_depthwise
...
class UPChannelRPN(RPN):
    ...
    def forward(self, z_f, x_f):
        ...
        cls = xcorr(cls_kernel, cls_feature)
        loc = self.loc_adjust(xcorr(loc_kernel, loc_feature))
        return cls, loc
