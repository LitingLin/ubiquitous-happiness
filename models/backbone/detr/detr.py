...
def build_backbone(net_config: dict):
    position_embedding = build_position_encoding(net_config)
    backbone_args = net_config['backbone']
    backbone = Backbone(backbone_args['type'], False, backbone_args['dilation'])
