...
class PyramidModule(nn.Module):
    def __init__(self, level_0_self_attention_modules, level_1_self_attention_modules, level_0_1_z_feature_fusion, level_0_1_x_feature_fusion):
        ...
        self.level_0_1_z_feature_fusion = level_0_1_z_feature_fusion
        self.level_0_1_x_feature_fusion = level_0_1_x_feature_fusion
    ...
    def forward(self,
        ...
        level_0_z, level_1_z = self.level_0_1_z_feature_fusion(level_0_z, level_1_z, level_0_z_H, level_0_z_W, level_1_z_H, level_1_z_W, level_0_z_feature_fusion_q_positional_encoding, level_1_z_feature_fusion_k_positional_encoding, level_1_z_feature_fusion_q_positional_encoding, level_0_z_feature_fusion_k_positional_encoding)
        level_0_x, level_1_x = self.level_0_1_x_feature_fusion(level_0_x, level_1_x, level_0_x_H, level_0_x_W, level_1_x_H, level_1_x_W, level_0_x_feature_fusion_q_positional_encoding, level_1_x_feature_fusion_k_positional_encoding, level_1_x_feature_fusion_q_positional_encoding, level_0_x_feature_fusion_k_positional_encoding)
