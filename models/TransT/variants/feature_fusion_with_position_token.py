...
def build_featurefusion_network(network_config: dict):
    return FeatureFusionNetwork(network_config['transformer']['hidden_dim'], network_config['transformer']['nheads'],
                                network_config['transformer']['featurefusion_layers'],
                                network_config['transformer']['dim_feedforward'],
                                network_config['transformer']['dropout'],
                                network_config['transformer']['activation'])
