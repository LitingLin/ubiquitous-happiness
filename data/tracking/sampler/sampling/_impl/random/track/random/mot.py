...
class MultipleObjectTrackingDatasetSequenceSampler:
    def __init__(self, data_getter, number_of_objects = 1, frame_range_size=None, sampling_allow_invalid_bounding_box=False, sampling_allow_duplication=True, sampling_allow_insufficiency=True, sort_result=False, rng_engine=np.random):
