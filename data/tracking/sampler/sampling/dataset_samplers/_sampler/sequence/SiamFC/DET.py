...
def do_sampling_in_detection_dataset_image(image: DetectionDatasetImage_MemoryMapped, rng_engine=np.random):
...
def get_one_random_sample_in_detection_dataset_image(image: DetectionDatasetImage_MemoryMapped, rng_engine=np.random):
