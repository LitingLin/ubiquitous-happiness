...
class TransTProcessor:
    ...
    def __call__(self, z_image, z_bbox, x_image, x_bbox, is_positive):
        miscellany = {}
        miscellany_element = None
        if self.with_raw_data:
            miscellany_element = {'z': z_image, 'x': x_image, 'z_bbox': z_bbox, 'x_bbox': x_bbox}
        ...
        if isinstance(labels, (list, tuple)):
            return z_image, x_image, z_context, x_context, miscellany, miscellany_element, *labels
        else:
            return z_image, x_image, z_context, x_context, miscellany, miscellany_element, labels
