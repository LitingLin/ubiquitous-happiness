...
def do_SiamFC_curation(image, output_size, curation_parameter, interpolation_mode, image_mean=None, output_img=None):
    if image_mean is None:
        image_mean = get_image_mean(image)
    output_image, _ = torch_scale_and_translate_align_corners(image, output_size, curation_parameter[0], curation_parameter[1], curation_parameter[2], image_mean, interpolation_mode, output_img)
