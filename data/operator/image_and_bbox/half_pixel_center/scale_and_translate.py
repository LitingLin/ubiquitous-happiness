...
from data.operator.bbox.half_pixel_offset.rasterization import bbox_rasterization
...
def tf_scale_and_translate_numpy(img, output_size, scale, input_center=(0, 0), output_center=(0, 0), background_color=(0, 0, 0), kernel_type='triangle', antialias=False):
    ...
    if not is_bbox_valid(bbox_compute_intersection(output_bbox, (0, 0, output_size[0], output_size[1]))):
